c*** XFLUXSA
c
      subroutine xfluxsa(ncol,nrow,nlay,nspc,saconc,
     &                  iclbeg,iclend,jcell,kcell,dy,dz,mscl,fluxo3,
     &                  cnco3,fluxnox,cncnox,fluxvoc,cncvoc)
c
c-----CAMx v4.02 030709
c
c-----------------------------------------------------------------------
...
c       dy       R  width of cell in Y direction
...
c
     ...
     &              (mscl(icl,jcell)*mscl(icl,jcell)*
     &               (flux(i1d)-flux(i1d-1)) / dy / dz(icl,jcell,kcell))
        enddo
c
