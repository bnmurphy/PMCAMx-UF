c-----------------------------------------------------------------------
c this is the single precision version of lsode from netlib
c modifications:
c   - pass info (rk,rrxn,gain,loss) to/from subroutines f and jac
...
c-----------------------------------------------------------------------
     ...
     2            rk,rrxn,gain,loss)
      ...
      real rk(1), rrxn(1), gain(1), loss(1)
c-----------------------------------------------------------------------
...
c abort the run if level = 2. ------------------------------------------
 100  if (level .ne. 2) return
      stop ' A level is equal to 2 in lsode.'
