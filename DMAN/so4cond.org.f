...
cdbg                  write(limit(7:11),'(I2,X,I2)') k,j
        ...
        if (dt.le.120.) then
           ...
           if (dt.le.600.) then
             gasfrac=0.989 ! not allow less than 1.1% of reduction exoponentally
           elseif (dt.le.700.) then
             gasfrac=0.991 ! not allow less than 0.9% of reduction exponentially
           elseif (dt.le.800.) then
             gasfrac=0.993 ! not allow less than 0.7% of reduction exponentially
           elseif (dt.le.850.) then
             gasfrac=0.995 ! not allow less than 0.5% of reduction exponentially
           elseif (dt.lt.900.) then
             gasfrac=0.998 ! not allow less than 0.2% of reduction exponentially
           else
             gasfrac=0.999 ! not allow less than 0.1% of reduction theoretically
           endif
        endif
