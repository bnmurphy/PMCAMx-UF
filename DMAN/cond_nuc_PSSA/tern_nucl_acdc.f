...
C
     ...
     &            (tern_nuc_tbl_RH(irh1) - tern_nuc_tbl_RH(irh))
      ...
      if (size(tern_nuc_tbl_CS) .gt. 1) then
          ii3  =  (cs - tern_nuc_tbl_CS(ics)) / 
     &            (tern_nuc_tbl_CS(ics1) - tern_nuc_tbl_CS(ics) )
      else
          ii3 = 0.d0
      end if
      if (size(tern_nuc_tbl_H2SO4) .gt. 1) then
          ii4  =  (cna - tern_nuc_tbl_H2SO4(icna)) / 
     &            (tern_nuc_tbl_H2SO4(icna1) - tern_nuc_tbl_H2SO4(icna) )
      else
          ii4 = 0.d0
      end if
      if (size(tern_nuc_tbl_NH3) .gt. 1) then
          ii5  =  (nh3 - tern_nuc_tbl_NH3(inh3)) / 
     &            (tern_nuc_tbl_NH3(inh31) - tern_nuc_tbl_NH3(inh3) )
      else
          ii5 = 0.d0
      end if
