...
cdbg      call avgnumck(avcnc(1),ncol(1),nrow(1),nlay(1),nspec,nspav)
cdbg      call numcheck(conc(1),ncol(1),nrow(1),nlay(1),nspec)
cdbg      call mnratios(conc(1),ncol(1),nrow(1),nlay(1),nspec,1)
      call emistrns(1)
cdbg      call mnratios(conc(1),ncol(1),nrow(1),nlay(1),nspec,2)
cdbg      write(*,*)'After emistrns'
cdbg      if ((time .ge. 100) .and. (time .lt. 115)) then
cdbg      call avgnumck(avcnc(1),ncol(1),nrow(1),nlay(1),nspec,nspav)
cdbg      call numcheck(conc(1),ncol(1),nrow(1),nlay(1),nspec)
cdbg      endif
c
...
c
cdbg      call mnratios(conc(1),ncol(1),nrow(1),nlay(1),nspec,3)
cdbg      call checkconc(conc(iptr4d(igrd)),ncol,nrow,nlay,nspec,
cdbg     &      spname,24)
      call chemrxn(1)
cdbg      call checkconc(conc(iptr4d(igrd)),ncol,nrow,nlay,nspec,
cdbg     &      spname,25)
cdbg      call mnratios(conc(1),ncol(1),nrow(1),nlay(1),nspec,4)
c
c-----Compute PiG mass
c
      if( ipigflg .EQ. IRONPIG .OR. ipigflg .EQ. GRESPIG ) then
