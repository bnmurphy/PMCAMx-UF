...
c
     ...
     &     (imap(97),ixyl ),(imap( 98),isoa1_1  ),(imap( 99),isoa1_2  ),
     &(imap(100),isoa1_3  ),(imap(101),isoa1_4  ),(imap(102),isoa1_5  ),
     &(imap(103),isoa1_6  ),(imap(104),isoa1_7  ),(imap(105),isoa1_8  ),
     &(imap(106),isoa1_9  ),(imap(107),isoa1_10 ),(imap(108),isoa2_1  ),
     &(imap(109),isoa2_2  ),(imap(110),isoa2_3  ),(imap(111),isoa2_4  ),
     &(imap(112),isoa2_5  ),(imap(113),isoa2_6  ),(imap(114),isoa2_7  ),
     &(imap(115),isoa2_8  ),(imap(116),isoa2_9  ),(imap(117),isoa2_10 ),
     &(imap(118),isoa3_1  ),(imap(119),isoa3_2  ),(imap(120),isoa3_3  ),
     &(imap(121),isoa3_4  ),(imap(122),isoa3_5  ),(imap(123),isoa3_6  ),
     &(imap(124),isoa3_7  ),(imap(125),isoa3_8  ),(imap(126),isoa3_9  ),
     &(imap(127),isoa3_10 ),(imap(128),isoa4_1  ),(imap(129),isoa4_2  ),
     &(imap(130),isoa4_3  ),(imap(131),isoa4_4  ),(imap(132),isoa4_5  ),
     &(imap(133),isoa4_6  ),(imap(134),isoa4_7  ),(imap(135),isoa4_8  ),
     &(imap(136),isoa4_9  ),(imap(137),isoa4_10 ),(imap(138),ipoc_1   ),
     &(imap(139),ipoc_2   ),(imap(140),ipoc_3   ),(imap(141),ipoc_4   ),
     &(imap(142),ipoc_5   ),(imap(143),ipoc_6   ),(imap(144),ipoc_7   ),
     &(imap(145),ipoc_8   ),(imap(146),ipoc_9   ),(imap(147),ipoc_10  ),
     &(imap(148),ipec_1   ),(imap(149),ipec_2   ),(imap(150),ipec_3   ),
     &(imap(151),ipec_4   ),(imap(152),ipec_5   ),(imap(153),ipec_6   ),
     &(imap(154),ipec_7   ),(imap(155),ipec_8   ),(imap(156),ipec_9   ),
     &(imap(157),ipec_10  ),(imap(158),icrust_1 ),(imap(159),icrust_2 ),
     &(imap(160),icrust_3 ),(imap(161),icrust_4 ),(imap(162),icrust_5 ),
     &(imap(163),icrust_6 ),(imap(164),icrust_7 ),(imap(165),icrust_8 ),
     &(imap(166),icrust_9 ),(imap(167),icrust_10),(imap(168),iph2o_1  ),
     &(imap(169),iph2o_2  ),(imap(170),iph2o_3  ),(imap(171),iph2o_4  ),
     &(imap(172),iph2o_5  ),(imap(173),iph2o_6  ),(imap(174),iph2o_7  ),
     &(imap(175),iph2o_8  ),(imap(176),iph2o_9  ),(imap(177),iph2o_10 ),
     &(imap(178),ipcl_1   ),(imap(179),ipcl_2   ),(imap(180),ipcl_3   ),
     &(imap(181),ipcl_4   ),(imap(182),ipcl_5   ),(imap(183),ipcl_6   ),
     &(imap(184),ipcl_7   ),(imap(185),ipcl_8   ),(imap(186),ipcl_9   ),
     &(imap(187),ipcl_10  ),(imap(188),ina_1    ),(imap(189),ina_2    ),
     &(imap(190),ina_3    ),(imap(191),ina_4    ),(imap(192),ina_5    ),
     &(imap(193),ina_6    ),(imap(194),ina_7    ),(imap(195),ina_8    ),
     &(imap(196),ina_9    ),(imap(197),ina_10   ),(imap(198),ipnh4_1  ),
     &(imap(199),ipnh4_2  ),(imap(200),ipnh4_3  ),(imap(201),ipnh4_4  ),
     &(imap(202),ipnh4_5  ),(imap(203),ipnh4_6  ),(imap(204),ipnh4_7  ),
     &(imap(205),ipnh4_8  ),(imap(206),ipnh4_9  ),(imap(207),ipnh4_10 ),
     &(imap(208),ipno3_1  ),(imap(209),ipno3_2  ),(imap(210),ipno3_3  ),
     &(imap(211),ipno3_4  ),(imap(212),ipno3_5  ),(imap(213),ipno3_6  ),
     &(imap(214),ipno3_7  ),(imap(215),ipno3_8  ),(imap(216),ipno3_9  ),
     &(imap(217),ipno3_10 ),(imap(218),ipso4_1  ),(imap(219),ipso4_2  ),
     &(imap(220),ipso4_3  ),(imap(221),ipso4_4  ),(imap(222),ipso4_5  ),
     &(imap(223),ipso4_6  ),(imap(224),ipso4_7  ),(imap(225),ipso4_8  ),
     &(imap(226),ipso4_9  ),(imap(227),ipso4_10 ),(imap(228),iph2o    )
c
