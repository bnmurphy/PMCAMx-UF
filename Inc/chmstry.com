...
c
     ...
     &            (kmap(97),kxn  ), (kmap(98),kxyl ),
     &            (kmap( 99),ksoa1_1  ),(kmap(100),ksoa1_2  ),
     ...
     &(kmap(157),ksoa2_17 ),(kmap(159),ksoa2_18 ),(kmap(160),ksoa2_19 ),
     ...
     &(kmap(271),ksoa5_1  ),(kmap(272),ksoa5_2  ),
     &(kmap(273),ksoa5_3  ),(kmap(274),ksoa5_4  ),(kmap(275),ksoa5_5  ),
     &(kmap(276),ksoa5_6  ),(kmap(277),ksoa5_7  ),(kmap(278),ksoa5_8  ),
     &(kmap(279),ksoa5_9  ),(kmap(280),ksoa5_10 ),(kmap(281),ksoa5_11 ),
     &(kmap(282),ksoa5_12 ),(kmap(283),ksoa5_13 ),(kmap(284),ksoa5_14 ),
     &(kmap(285),ksoa5_15 ),(kmap(286),ksoa5_16 ),(kmap(287),ksoa5_17 ),
     &(kmap(288),ksoa5_18 ),(kmap(289),ksoa5_19 ),(kmap(290),ksoa5_20 ),
     &(kmap(291),ksoa5_21 ),(kmap(292),ksoa5_22 ),(kmap(293),ksoa5_23 ),
     &(kmap(294),ksoa5_24 ),(kmap(295),ksoa5_25 ),(kmap(296),ksoa5_26 ),
     &(kmap(297),ksoa5_27 ),(kmap(298),ksoa5_28 ),(kmap(299),ksoa5_29 ),
     &(kmap(300),ksoa5_30 ),(kmap(301),ksoa5_31 ),(kmap(302),ksoa5_32 ),
     &(kmap(303),ksoa5_33 ),(kmap(304),ksoa5_34 ),(kmap(305),ksoa5_35 ),
     &(kmap(306),ksoa5_36 ),(kmap(307),ksoa5_37 ),(kmap(308),ksoa5_38 ),
     &(kmap(309),ksoa5_39 ),(kmap(310),ksoa5_40 ),(kmap(311),ksoa5_41 ),
     &(kmap(312),ksoa5_42 ),(kmap(313),ksoa5_43 ),

     &(kmap(314),kpoc_1   ),
     &(kmap(315),kpoc_2   ),(kmap(316),kpoc_3   ),(kmap(317),kpoc_4   ),
     &(kmap(318),kpoc_5   ),(kmap(319),kpoc_6   ),(kmap(320),kpoc_7   ),
     &(kmap(321),kpoc_8   ),(kmap(322),kpoc_9   ),(kmap(323),kpoc_10  ),
     &(kmap(324),kpoc_11  ),(kmap(324),kpoc_12  ),(kmap(326),kpoc_13  ),
     &(kmap(327),kpoc_14  ),(kmap(328),kpoc_15  ),(kmap(329),kpoc_16  ),
     &(kmap(330),kpoc_17  ),(kmap(331),kpoc_18  ),(kmap(332),kpoc_19  ),
     &(kmap(333),kpoc_20  ),(kmap(334),kpoc_21  ),(kmap(335),kpoc_22  ),
     &(kmap(336),kpoc_23  ),(kmap(337),kpoc_24  ),(kmap(338),kpoc_25  ),
     &(kmap(339),kpoc_26  ),(kmap(340),kpoc_27  ),(kmap(341),kpoc_28  ),
     &(kmap(342),kpoc_29  ),(kmap(343),kpoc_30  ),(kmap(344),kpoc_31  ),
     &(kmap(345),kpoc_32  ),(kmap(346),kpoc_33  ),(kmap(347),kpoc_34  ),
     &(kmap(348),kpoc_35  ),(kmap(349),kpoc_36  ),(kmap(350),kpoc_37  ),
     &(kmap(351),kpoc_38  ),(kmap(352),kpoc_39  ),(kmap(353),kpoc_40  ),
     &(kmap(354),kpoc_41  ),(kmap(355),kpoc_42  ),(kmap(356),kpoc_43  ),

     &(kmap(357),kpec_1   ),(kmap(358),kpec_2   ),(kmap(359),kpec_3   ),
     &(kmap(360),kpec_4   ),(kmap(361),kpec_5   ),(kmap(362),kpec_6   ),
     &(kmap(363),kpec_7   ),(kmap(364),kpec_8   ),(kmap(365),kpec_9   ),
     &(kmap(366),kpec_10  ),(kmap(367),kpec_11  ),(kmap(368),kpec_12  ),
     &(kmap(369),kpec_13  ),(kmap(370),kpec_14  ),(kmap(371),kpec_15  ),
     &(kmap(372),kpec_16  ),(kmap(373),kpec_17  ),(kmap(374),kpec_18  ),
     &(kmap(375),kpec_19  ),(kmap(376),kpec_20  ),(kmap(377),kpec_21  ),
     &(kmap(378),kpec_22  ),(kmap(379),kpec_23  ),(kmap(380),kpec_24  ),
     &(kmap(381),kpec_25  ),(kmap(382),kpec_26  ),(kmap(383),kpec_27  ),
     &(kmap(384),kpec_28  ),(kmap(385),kpec_29  ),(kmap(386),kpec_30  ),
     &(kmap(387),kpec_31  ),(kmap(388),kpec_32  ),(kmap(389),kpec_33  ),
     &(kmap(390),kpec_34  ),(kmap(391),kpec_35  ),(kmap(392),kpec_36  ),
     &(kmap(393),kpec_37  ),(kmap(394),kpec_38  ),(kmap(395),kpec_39  ),
     &(kmap(396),kpec_40  ),(kmap(397),kpec_41  ),(kmap(398),kpec_42  ),
     &(kmap(399),kpec_43  ),

     &(kmap(400),kcrust_1 ),(kmap(401),kcrust_2 ),
     &(kmap(402),kcrust_3 ),(kmap(403),kcrust_4 ),(kmap(404),kcrust_5 ),
     &(kmap(405),kcrust_6 ),(kmap(406),kcrust_7 ),(kmap(407),kcrust_8 ),
     &(kmap(408),kcrust_9 ),(kmap(409),kcrust_10),(kmap(410),kcrust_11),
     &(kmap(411),kcrust_12),(kmap(412),kcrust_13),(kmap(413),kcrust_14),
     &(kmap(414),kcrust_15),(kmap(415),kcrust_16),(kmap(416),kcrust_17),
     &(kmap(417),kcrust_18),(kmap(418),kcrust_19),(kmap(419),kcrust_20),
     &(kmap(420),kcrust_21),(kmap(421),kcrust_22),(kmap(422),kcrust_23),
     &(kmap(423),kcrust_24),(kmap(424),kcrust_25),(kmap(425),kcrust_26),
     &(kmap(426),kcrust_27),(kmap(427),kcrust_28),(kmap(428),kcrust_29),
     &(kmap(429),kcrust_30),(kmap(430),kcrust_31),(kmap(431),kcrust_32),
     &(kmap(432),kcrust_33),(kmap(433),kcrust_34),(kmap(434),kcrust_35),
     &(kmap(435),kcrust_36),(kmap(436),kcrust_37),(kmap(437),kcrust_38),
     &(kmap(438),kcrust_39),(kmap(439),kcrust_40),(kmap(440),kcrust_41),
     &(kmap(441),kcrust_42),(kmap(442),kcrust_43),

     &(kmap(443),kph2o_1  ),
     &(kmap(444),kph2o_2  ),(kmap(445),kph2o_3  ),(kmap(446),kph2o_4  ),
     &(kmap(447),kph2o_5  ),(kmap(448),kph2o_6  ),(kmap(449),kph2o_7  ),
     &(kmap(450),kph2o_8  ),(kmap(451),kph2o_9  ),(kmap(452),kph2o_10 ),
     &(kmap(453),kph2o_11 ),(kmap(454),kph2o_12 ),(kmap(455),kph2o_13 ),
     &(kmap(456),kph2o_14 ),(kmap(457),kph2o_15 ),(kmap(458),kph2o_16 ),
     &(kmap(459),kph2o_17 ),(kmap(460),kph2o_18 ),(kmap(461),kph2o_19 ),
     &(kmap(462),kph2o_20 ),(kmap(463),kph2o_21 ),(kmap(464),kph2o_22 ),
     &(kmap(465),kph2o_23 ),(kmap(466),kph2o_24 ),(kmap(467),kph2o_25 ),
     &(kmap(468),kph2o_26 ),(kmap(469),kph2o_27 ),(kmap(470),kph2o_28 ),
     &(kmap(471),kph2o_29 ),(kmap(472),kph2o_30 ),(kmap(473),kph2o_31 ),
     &(kmap(474),kph2o_32 ),(kmap(475),kph2o_33 ),(kmap(476),kph2o_34 ),
     &(kmap(477),kph2o_35 ),(kmap(478),kph2o_36 ),(kmap(479),kph2o_37 ),
     &(kmap(480),kph2o_38 ),(kmap(481),kph2o_39 ),(kmap(482),kph2o_40 ),
     &(kmap(483),kph2o_41 ),(kmap(484),kph2o_42 ),(kmap(485),kph2o_43 ),

     &(kmap(486),kpcl_1   ),(kmap(487),kpcl_2   ),(kmap(488),kpcl_3   ),
     &(kmap(489),kpcl_4   ),(kmap(490),kpcl_5   ),(kmap(491),kpcl_6   ),
     &(kmap(492),kpcl_7   ),(kmap(493),kpcl_8   ),(kmap(494),kpcl_9   ),
     &(kmap(495),kpcl_10  ),(kmap(496),kpcl_11  ),(kmap(497),kpc1_12  ),
     &(kmap(498),kpcl_13  ),(kmap(499),kpcl_14  ),(kmap(500),kpcl_15  ),
     &(kmap(501),kpcl_16  ),(kmap(502),kpcl_17  ),(kmap(503),kpcl_18  ),
     &(kmap(504),kpcl_19  ),(kmap(505),kpcl_20  ),(kmap(506),kpcl_21  ),
     &(kmap(507),kpcl_22  ),(kmap(508),kpcl_23  ),(kmap(509),kpc1_24  ),
     &(kmap(510),kpcl_25  ),(kmap(511),kpcl_26  ),(kmap(512),kpc1_27  ),
     &(kmap(513),kpcl_28  ),(kmap(514),kpcl_29  ),(kmap(515),kpcl_30  ),
     &(kmap(516),kpcl_31  ),(kmap(517),kpcl_32  ),(kmap(518),kpcl_33  ),
     &(kmap(519),kpcl_34  ),(kmap(520),kpcl_35  ),(kmap(521),kpcl_36  ),
     &(kmap(522),kpcl_37  ),(kmap(523),kpcl_38  ),(kmap(524),kpc1_39  ),
     &(kmap(525),kpcl_40  ),(kmap(526),kpcl_41  ),(kmap(528),kpc1_42  ),
     &(kmap(528),kpcl_43  ),

     &(kmap(529),kna_1    ),(kmap(530),kna_2    ),
     &(kmap(531),kna_3    ),(kmap(532),kna_4    ),(kmap(533),kna_5    ),
     &(kmap(534),kna_6    ),(kmap(535),kna_7    ),(kmap(536),kna_8    ),
     &(kmap(537),kna_9    ),(kmap(538),kna_10   ),(kmap(539),kna_11   ),
     &(kmap(540),kna_12   ),(kmap(541),kna_13   ),(kmap(542),kna_14   ),
     &(kmap(543),kna_15   ),(kmap(544),kna_16   ),(kmap(545),kna_17   ),
     &(kmap(546),kna_18   ),(kmap(547),kna_19   ),(kmap(548),kna_20   ),
     &(kmap(549),kna_21   ),(kmap(550),kna_22   ),(kmap(551),kna_23   ),
     &(kmap(552),kna_24   ),(kmap(553),kna_25   ),(kmap(554),kna_26   ),
     &(kmap(555),kna_27   ),(kmap(556),kna_28   ),(kmap(557),kna_29   ),
     &(kmap(558),kna_30   ),(kmap(559),kna_31   ),(kmap(560),kna_32   ),
     &(kmap(561),kna_33   ),(kmap(562),kna_34   ),(kmap(563),kna_35   ),
     &(kmap(564),kna_36   ),(kmap(565),kna_37   ),(kmap(566),kna_38   ),
     &(kmap(567),kna_39   ),(kmap(568),kna_40   ),(kmap(569),kna_41   ),
     &(kmap(570),kna_42   ),(kmap(571),kna_43   ),

     &(kmap(572),kpnh4_1  ),
     &(kmap(573),kpnh4_2  ),(kmap(574),kpnh4_3  ),(kmap(575),kpnh4_4  ),
     &(kmap(576),kpnh4_5  ),(kmap(577),kpnh4_6  ),(kmap(578),kpnh4_7  ),
     &(kmap(579),kpnh4_8  ),(kmap(580),kpnh4_9  ),(kmap(581),kpnh4_10 ),
     &(kmap(582),kpnh4_11 ),(kmap(583),kpnh4_12 ),(kmap(584),kpnh4_13 ),
     &(kmap(585),kpnh4_14 ),(kmap(586),kpnh4_15 ),(kmap(587),kpnh4_16 ),
     &(kmap(588),kpnh4_17 ),(kmap(589),kpnh4_18 ),(kmap(590),kpnh4_19 ),
     &(kmap(591),kpnh4_20 ),(kmap(592),kpnh4_21 ),(kmap(593),kpnh4_22 ),
     &(kmap(594),kpnh4_23 ),(kmap(595),kpnh4_24 ),(kmap(596),kpnh4_25 ),
     &(kmap(597),kpnh4_26 ),(kmap(598),kpnh4_27 ),(kmap(599),kpnh4_28 ),
     &(kmap(600),kpnh4_29 ),(kmap(601),kpnh4_30 ),(kmap(602),kpnh4_31 ),
     &(kmap(603),kpnh4_32 ),(kmap(604),kpnh4_33 ),(kmap(605),kpnh4_34 ),
     &(kmap(606),kpnh4_35 ),(kmap(607),kpnh4_36 ),(kmap(608),kpnh4_37 ),
     &(kmap(609),kpnh4_38 ),(kmap(610),kpnh4_39 ),(kmap(611),kpnh4_40 ),
     &(kmap(612),kpnh4_41 ),(kmap(613),kpnh4_42 ),(kmap(614),kpnh4_43 ),

     &(kmap(615),kpno3_1  ),(kmap(616),kpno3_2  ),(kmap(617),kpno3_3  ),
     &(kmap(618),kpno3_4  ),(kmap(619),kpno3_5  ),(kmap(620),kpno3_6  ),
     &(kmap(621),kpno3_7  ),(kmap(622),kpno3_8  ),(kmap(623),kpno3_9  ),
     &(kmap(624),kpno3_10 ),(kmap(625),kpno3_11 ),(kmap(626),kpno3_12 ),
     &(kmap(627),kpno3_13 ),(kmap(628),kpno3_14 ),(kmap(629),kpno3_15 ),
     &(kmap(630),kpno3_16 ),(kmap(631),kpno3_17 ),(kmap(632),kpno3_18 ),
     &(kmap(633),kpno3_19 ),(kmap(634),kpno3_20 ),(kmap(635),kpno3_21 ),
     &(kmap(636),kpno3_22 ),(kmap(637),kpno3_23 ),(kmap(638),kpno3_24 ),
     &(kmap(639),kpno3_25 ),(kmap(640),kpno3_26 ),(kmap(641),kpno3_27 ),
     &(kmap(642),kpno3_28 ),(kmap(643),kpno3_29 ),(kmap(644),kpno3_30 ),
     &(kmap(645),kpno3_31 ),(kmap(646),kpno3_32 ),(kmap(647),kpno3_33 ),
     &(kmap(648),kpno3_34 ),(kmap(649),kpno3_35 ),(kmap(650),kpno3_36 ),
     &(kmap(651),kpno3_37 ),(kmap(652),kpno3_38 ),(kmap(653),kpno3_39 ),
     &(kmap(654),kpno3_40 ),(kmap(655),kpno3_41 ),(kmap(656),kpno3_42 ),
     &(kmap(657),kpno3_43),

     &(kmap(658),kpso4_1  ),(kmap(659),kpso4_2  ),
     &(kmap(660),kpso4_3  ),(kmap(661),kpso4_4  ),(kmap(662),kpso4_5  ),
     &(kmap(663),kpso4_6  ),(kmap(664),kpso4_7  ),(kmap(665),kpso4_8  ),
     &(kmap(666),kpso4_9  ),(kmap(667),kpso4_10 ),(kmap(668),kpso4_11 ),
     &(kmap(669),kpso4_12 ),(kmap(670),kpso4_13 ),(kmap(671),kpso4_14 ),
     &(kmap(672),kpso4_15 ),(kmap(673),kpso4_16 ),(kmap(674),kpso4_17 ),
     &(kmap(675),kpso4_18 ),(kmap(676),kpso4_19 ),(kmap(677),kpso4_20 ),
     &(kmap(678),kpso4_21 ),(kmap(679),kpso4_22 ),(kmap(680),kpso4_23 ),
     &(kmap(681),kpso4_24 ),(kmap(682),kpso4_25 ),(kmap(683),kpso4_26 ),
     &(kmap(684),kpso4_27 ),(kmap(685),kpso4_28 ),(kmap(686),kpso4_29 ),
     &(kmap(687),kpso4_30 ),(kmap(688),kpso4_31 ),(kmap(689),kpso4_32 ),
     &(kmap(690),kpso4_33 ),(kmap(691),kpso4_34 ),(kmap(692),kpso4_35 ),
     &(kmap(693),kpso4_36 ),(kmap(694),kpso4_37 ),(kmap(695),kpso4_38 ),
     &(kmap(696),kpso4_39 ),(kmap(697),kpso4_40 ),(kmap(698),kpso4_41 ),
     &(kmap(699),kpso4_42 ),(kmap(700),kpso4_43 ),
     ...
     &(kmap(745),kbpin),(kmap(746),klimo),(kmap(747),kmono),
     &(kmap(748),ksesq),(kmap(749),kcg5)
