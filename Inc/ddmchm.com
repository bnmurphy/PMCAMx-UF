...
c
     ...
     &     (lmap(97),lxyl ),(lmap( 98),lsoa1_1  ),(lmap( 99),lsoa1_2  ),
     &(lmap(100),lsoa1_3  ),(lmap(101),lsoa1_4  ),(lmap(102),lsoa1_5  ),
     &(lmap(103),lsoa1_6  ),(lmap(104),lsoa1_7  ),(lmap(105),lsoa1_8  ),
     &(lmap(106),lsoa1_9  ),(lmap(107),lsoa1_10 ),(lmap(108),lsoa2_1  ),
     &(lmap(109),lsoa2_2  ),(lmap(110),lsoa2_3  ),(lmap(111),lsoa2_4  ),
     &(lmap(112),lsoa2_5  ),(lmap(113),lsoa2_6  ),(lmap(114),lsoa2_7  ),
     &(lmap(115),lsoa2_8  ),(lmap(116),lsoa2_9  ),(lmap(117),lsoa2_10 ),
     &(lmap(118),lsoa3_1  ),(lmap(119),lsoa3_2  ),(lmap(120),lsoa3_3  ),
     &(lmap(121),lsoa3_4  ),(lmap(122),lsoa3_5  ),(lmap(123),lsoa3_6  ),
     &(lmap(124),lsoa3_7  ),(lmap(125),lsoa3_8  ),(lmap(126),lsoa3_9  ),
     &(lmap(127),lsoa3_10 ),(lmap(128),lsoa4_1  ),(lmap(129),lsoa4_2  ),
     &(lmap(130),lsoa4_3  ),(lmap(131),lsoa4_4  ),(lmap(132),lsoa4_5  ),
     &(lmap(133),lsoa4_6  ),(lmap(134),lsoa4_7  ),(lmap(135),lsoa4_8  ),
     &(lmap(136),lsoa4_9  ),(lmap(137),lsoa4_10 ),(lmap(138),lpoc_1   ),
     &(lmap(139),lpoc_2   ),(lmap(140),lpoc_3   ),(lmap(141),lpoc_4   ),
     &(lmap(142),lpoc_5   ),(lmap(143),lpoc_6   ),(lmap(144),lpoc_7   ),
     &(lmap(145),lpoc_8   ),(lmap(146),lpoc_9   ),(lmap(147),lpoc_10  ),
     &(lmap(148),lpec_1   ),(lmap(149),lpec_2   ),(lmap(150),lpec_3   ),
     &(lmap(151),lpec_4   ),(lmap(152),lpec_5   ),(lmap(153),lpec_6   ),
     &(lmap(154),lpec_7   ),(lmap(155),lpec_8   ),(lmap(156),lpec_9   ),
     &(lmap(157),lpec_10  ),(lmap(158),lcrust_1 ),(lmap(159),lcrust_2 ),
     &(lmap(160),lcrust_3 ),(lmap(161),lcrust_4 ),(lmap(162),lcrust_5 ),
     &(lmap(163),lcrust_6 ),(lmap(164),lcrust_7 ),(lmap(165),lcrust_8 ),
     &(lmap(166),lcrust_9 ),(lmap(167),lcrust_10),(lmap(168),lph2o_1  ),
     &(lmap(169),lph2o_2  ),(lmap(170),lph2o_3  ),(lmap(171),lph2o_4  ),
     &(lmap(172),lph2o_5  ),(lmap(173),lph2o_6  ),(lmap(174),lph2o_7  ),
     &(lmap(175),lph2o_8  ),(lmap(176),lph2o_9  ),(lmap(177),lph2o_10 ),
     &(lmap(178),lpcl_1   ),(lmap(179),lpcl_2   ),(lmap(180),lpcl_3   ),
     &(lmap(181),lpcl_4   ),(lmap(182),lpcl_5   ),(lmap(183),lpcl_6   ),
     &(lmap(184),lpcl_7   ),(lmap(185),lpcl_8   ),(lmap(186),lpcl_9   ),
     &(lmap(187),lpcl_10  ),(lmap(188),lna_1    ),(lmap(189),lna_2    ),
     &(lmap(190),lna_3    ),(lmap(191),lna_4    ),(lmap(192),lna_5    ),
     &(lmap(193),lna_6    ),(lmap(194),lna_7    ),(lmap(195),lna_8    ),
     &(lmap(196),lna_9    ),(lmap(197),lna_10   ),(lmap(198),lpnh4_1  ),
     &(lmap(199),lpnh4_2  ),(lmap(200),lpnh4_3  ),(lmap(201),lpnh4_4  ),
     &(lmap(202),lpnh4_5  ),(lmap(203),lpnh4_6  ),(lmap(204),lpnh4_7  ),
     &(lmap(205),lpnh4_8  ),(lmap(206),lpnh4_9  ),(lmap(207),lpnh4_10 ),
     &(lmap(208),lpno3_1  ),(lmap(209),lpno3_2  ),(lmap(210),lpno3_3  ),
     &(lmap(211),lpno3_4  ),(lmap(212),lpno3_5  ),(lmap(213),lpno3_6  ),
     &(lmap(214),lpno3_7  ),(lmap(215),lpno3_8  ),(lmap(216),lpno3_9  ),
     &(lmap(217),lpno3_10 ),(lmap(218),lpso4_1  ),(lmap(219),lpso4_2  ),
     &(lmap(220),lpso4_3  ),(lmap(221),lpso4_4  ),(lmap(222),lpso4_5  ),
     &(lmap(223),lpso4_6  ),(lmap(224),lpso4_7  ),(lmap(225),lpso4_8  ),
     &(lmap(226),lpso4_9  ),(lmap(227),lpso4_10 ),(lmap(228),lph2o    )
c
