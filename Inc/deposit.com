...
c
cjgj      parameter (nsecfin = 5) !fine particles from 0.04 to 1.25 um
cjgj      parameter (nseccrs = 3) !coarse particles from 1.25 to 10 um
      parameter (nsecfin = 33)
      parameter (nseccrs = 8)
...
c
cjgj      data diadep /0.055013, 0.12847,     0.3, 0.70057,  1.6360,
cjgj     &               3.8204,  8.9214,  20.833/

cjgj      data wfdep  /  0.0294,  0.2094,  0.4061,  0.2216,  0.1335,
cjgj     &               0.4078,  0.4205,  0.1717/
