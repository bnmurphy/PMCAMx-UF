      subroutine radslvr1(ldark,H2O,M,O2,CH4,H2,cncrad,conc,r)
c
c-----CAMx v4.02 030709
c
c     RADSLVR1 initializes radical concentrations
c
...
c
      if (ldark) then
        ...
        Loss(kCL   )= +( 1.000)*r( 99)+( 1.000)*r(102)+( 1.000)*r(103)
     &                +( 1.000)*r(104)+( 1.000)*r(105)+( 1.000)*r(106)
     &                +( 1.000)*r(108)
        Gain(kCL   )= +( 2.000)*r( 97)+( 1.000)*r( 98)+( 1.000)*r(100)
     &                +( 1.400)*r(110)
        cncrad(kCL) = gain(kCL)/loss(kCL)*cncrad(kCL)
        cncrad(kCL) = amax1(bdlrad, cncrad(kCL))
      r( 99) = rk( 99)*cncrad(kCL)*conc(kO3)
      r(102) = rk(102)*cncrad(kCL)*conc(kPAR)
      r(103) = rk(103)*cncrad(kCL)*conc(kOLE)
      r(104) = rk(104)*cncrad(kCL)
      r(105) = rk(105)*cncrad(kCL)*conc(kETH)
      r(106) = rk(106)*cncrad(kCL)*conc(kISOP)
      r(108) = rk(108)*cncrad(kCL)*conc(kBUTA)
      endif
c
c  new group of radicals
c
c    CL   CLO
c
c  this radical group is formed by photolysis only
c
      if (ldark) then
        nstrt = kCL
        nend  = kCLO
  ...
  14  kount = kount + 1
      if (kount.gt.100) then
        write(iout,'(//,A)') 'ERROR in RADSLVR1:'
        write(iout,*) 'No Convergence in RADSLVR1, errbig = ', errbig
     ...
     &                +( 1.000)*r(108)
        Gain(kCL   )= +( 2.000)*r( 97)+( 1.000)*r( 98)+( 1.000)*r(100)
     &                +( 1.400)*r(110)
        Loss(kCLO  )= +( 1.000)*r(100)+( 1.000)*r(101)+( 2.000)*r(110)
        Gain(kCLO  )= +( 1.000)*r( 99)

          JAC(kCL  ,kCL  )= +( 1.000)*r( 99)+( 1.000)*r(102)
     &                      +( 1.000)*r(103)+( 1.000)*r(104)
     &                      +( 1.000)*r(105)+( 1.000)*r(106)
     &                      +( 1.000)*r(108)
          JAC(kCL  ,kCLO )= +(-1.000)*r(100)+(-2.800)*r(110)
          JAC(kCLO ,kCL  )= +(-1.000)*r( 99)
          JAC(kCLO ,kCLO )= +( 1.000)*r(100)+( 1.000)*r(101)
     &                      +( 4.000)*r(110)
c
...
c
      r( 99) = rk( 99)*cncrad(kCL)*conc(kO3)
      r(100) = rk(100)*cncrad(kCLO)*conc(kNO)
      r(101) = rk(101)*cncrad(kCLO)*cncrad(kHO2)
      r(102) = rk(102)*cncrad(kCL)*conc(kPAR)
      r(103) = rk(103)*cncrad(kCL)*conc(kOLE)
      r(104) = rk(104)*cncrad(kCL)
      r(105) = rk(105)*cncrad(kCL)*conc(kETH)
      r(106) = rk(106)*cncrad(kCL)*conc(kISOP)
      r(108) = rk(108)*cncrad(kCL)*conc(kBUTA)
      r(110) = rk(110)*cncrad(kCLO)*cncrad(kCLO)
...
c
  ...
  15  kount = kount + 1
      if (kount.gt.100) then
        write(iout,'(//,A)') 'ERROR in RADSLVR1:'
        write(iout,*) 'No Convergence in RADSLVR1, errbig = ', errbig
        write(iout,*) 'statement number = ', 15
        write(iout,*) 'igrd,i, j, k = ', igrdchm,ichm,jchm,kchm
        write(iout,*) 'LDARK is set ', ldark
        do l=1,ngas
          write(iout,'(i3,2x,a7,1pe10.3)') l,spname(l),conc(l)
...
c
  ...
  16  kount = kount + 1
      if (kount.gt.100) then
        write(iout,'(//,A)') 'ERROR in RADSLVR1:'
        write(iout,*) 'No Convergence in RADSLVR1, errbig = ', errbig
        write(iout,*) 'statement number = ', 16
        write(iout,*) 'igrd,i, j, k = ', igrdchm,ichm,jchm,kchm
        write(iout,*) 'LDARK is set ', ldark
        do l=1,ngas
          write(iout,'(i3,2x,a7,1pe10.3)') l,spname(l),conc(l)
...
c
        ...
        Gain(kROR  )= +( 0.760)*r( 52)+( 0.760)*r(102)
c
c  first order method chosen for this radical
c  solved by direct substitution
c
     ...
     &                +( 1.000)*r( 92)+( 1.000)*r(107)+( 1.000)*r(109)
     ...
     &                +( 0.266)*r( 77)+( 0.268)*r( 93)+( 1.000)*r( 98)
     ...
     &                +( 0.800)*r( 96)+( 1.000)*r(103)+( 1.000)*r(104)
     &                +( 1.000)*r(105)+( 1.000)*r(106)+( 1.000)*r(108)
     ...
     &                +( 0.064)*r( 93)+( 0.075)*r( 94)+( 0.700)*r( 95)
        Gain(kXO2  ) = Gain(kXO2  )
     &                +( 1.000)*r( 96)+( 0.870)*r(102)+( 2.000)*r(103)
     &                +( 1.000)*r(104)+( 2.000)*r(105)+( 1.000)*r(106)
     &                +( 1.000)*r(108)
        Loss(kXO2N )= +( 1.000)*r( 81)+( 1.000)*r( 87)+( 2.000)*r( 88)
     &                +( 1.000)*r( 89)
        Gain(kXO2N )= +( 0.130)*r( 52)+( 0.040)*r( 53)+( 0.020)*r( 56)
     &                +( 0.090)*r( 59)+( 0.088)*r( 76)+( 0.130)*r(102)
        Loss(kTO2  )= +( 1.000)*r( 64)+( 1.000)*r( 65)
        Gain(kTO2  )= +( 0.560)*r( 63)+( 0.300)*r( 72)
        Loss(kROR  )= +( 1.000)*r( 53)+( 1.000)*r( 54)+( 1.000)*r( 55)
        Gain(kROR  )= +( 0.760)*r( 52)+( 0.760)*r(102)
...
c
      ...
      r(101) = rk(101)*cncrad(kCLO)*cncrad(kHO2)
      r(107) = rk(107)*cncrad(kOH)*conc(kICL1)
      r(109) = rk(109)*cncrad(kOH)*conc(kBCL1)
      if (errbig.gt.tol) goto 16
c
c  new group of radicals
c
c   TO2
