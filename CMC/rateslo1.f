      subroutine rateslo1(neq1,r,rate)
c
c-----CAMx v4.02 030709
c
...
c  MEOH  ETOH  ISPD   CL2  HOCL  FMCL   HCL  ICL1  ICL2  BUTA
c  BCL1  BCL2
c
     ...
     &                +( 0.800)*r( 96)
        Loss(kPAR  )= +( 1.000)*r( 52)+( 1.000)*r(102)
     ...
     &                +( 0.200)*r( 78)+( 0.200)*r( 96)
        Loss(kCL2  )= +( 1.000)*r( 97)
        Gain(kCL2  )= +( 0.300)*r(110)
        Loss(kHOCL )= +( 1.000)*r( 98)
        Gain(kHOCL )= +( 1.000)*r(101)

        Gain(kFMCL )= +( 1.000)*r(103)+( 1.000)*r(105)

        Gain(kHCL  )= +( 1.000)*r(102)+( 1.000)*r(104)+( 0.150)*r(106)
        Loss(kICL1 )= +( 1.000)*r(107)
        Gain(kICL1 )= +( 0.280)*r(106)

        Gain(kICL2 )= +( 1.000)*r(107)
        Loss(kBUTA )= +( 1.000)*r(108)

        Loss(kBCL1 )= +( 1.000)*r(109)
        Gain(kBCL1 )= +( 0.700)*r(108)

        Gain(kBCL2 )= +( 1.000)*r(109)
      do l=neq1+1,ngas
