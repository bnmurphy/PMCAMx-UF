...
C	ALK4 -> ASOG (10 ug/m3)
        Gain(kcg2 )= +(0.0244*(1-B) + 0.0122*B )*r(200)

C	ALK5 -> ASOG (10 ug/m3)
        Gain(kcg2 )= +Gain(kcg2 )+(0.1426*(1-B) + 0.0713*B )*r(201)

C	ARO1 -> ASOG  (Based on Hildebrandt et al Toluene Yields)
        Gain(kcg1 )= +(0.0048*(1-B) + 0.0048*B )*r(202)
        Gain(kcg2 )= +Gain(kcg2 )+(0.1148*(1-B) + 0.1148*B )*r(202)
        Gain(kcg3 )= +(0.3349*(1-B) + 0.2153*B )*r(202)
        Gain(kcg4 )= +(0.4306*(1-B) + 0.3349*B )*r(202)

C	ARO2 -> ASOG
        Gain(kcg1 )= +Gain(kcg1 )+(0.0380*(1-B) + 0.0008*B )*r(203)
        Gain(kcg2 )= +Gain(kcg2 )+(0.1519*(1-B) + 0.0987*B )*r(203)
        Gain(kcg3 )= +Gain(kcg3 )+(0.1899*(1-B) + 0.1519*B )*r(203)
        Gain(kcg4 )= +Gain(kcg4 )+(0.2658*(1-B) + 0.2203*B )*r(203)

C	OLE1 -> ASOG
        Gain(kcg1 )= +Gain(kcg1 )+(0.0012*(1-B) + 0.0002*B )*r(204)
     &                +(0.0012*(1-B) + 0.0002*B )*r(205)
     &                +(0.0012*(1-B) + 0.0002*B )*r(206)
     &                +(0.0012*(1-B) + 0.0002*B )*r(207)
        Gain(kcg2 )= +Gain(kcg2 )+(0.0025*(1-B) + 0.0012*B )*r(204)
     &                +(0.0025*(1-B) + 0.0012*B )*r(205)
     &                +(0.0025*(1-B) + 0.0012*B )*r(206)
     &                +(0.0025*(1-B) + 0.0012*B )*r(207)
        Gain(kcg3 )= +Gain(kcg3 )+(0.0165*(1-B) + 0.0103*B )*r(204)
     &                +(0.0165*(1-B) + 0.0103*B )*r(205)
     &                +(0.0165*(1-B) + 0.0103*B )*r(206)
     &                +(0.0165*(1-B) + 0.0103*B )*r(207)
        Gain(kcg4 )= +Gain(kcg4 )+(0.0617*(1-B) + 0.0411*B )*r(204)
     &                +(0.0617*(1-B) + 0.0411*B )*r(205)
     &                +(0.0617*(1-B) + 0.0411*B )*r(206)
     &                +(0.0617*(1-B) + 0.0411*B )*r(207)

C	OLE2 -> ASOG
        Gain(kcg1 )= +Gain(kcg1 )+(0.0079*(1-B) + 0.0011*B )*r(208)
     &                +(0.0079*(1-B) + 0.0011*B )*r(209)
     &                +(0.0079*(1-B) + 0.0011*B )*r(210)
     &                +(0.0079*(1-B) + 0.0011*B )*r(211)
        Gain(kcg2 )= +Gain(kcg2 )+(0.0153*(1-B) + 0.0090*B )*r(208)
     &                +(0.0153*(1-B) + 0.0090*B )*r(209)
     &                +(0.0153*(1-B) + 0.0090*B )*r(210)
     &                +(0.0153*(1-B) + 0.0090*B )*r(211)
        Gain(kcg3 )= +Gain(kcg3 )+(0.0453*(1-B) + 0.0290*B )*r(208)
     &                +(0.0453*(1-B) + 0.0290*B )*r(209)
     &                +(0.0453*(1-B) + 0.0290*B )*r(210)
     &                +(0.0453*(1-B) + 0.0290*B )*r(211)
        Gain(kcg4 )= +Gain(kcg4 )+(0.1318*(1-B) + 0.0949*B )*r(208)
     &                +(0.1318*(1-B) + 0.0949*B )*r(209)
     &                +(0.1318*(1-B) + 0.0949*B )*r(210)
     &                +(0.1318*(1-B) + 0.0949*B )*r(211)

C	ISOP -> BSOG
        Gain(kcg1 )= + Gain(kcg1 )+(0.0023*(1-B) + 0.0001*B )*r(189)
     &                +(0.0023*(1-B) + 0.0001*B )*r(190)
        Gain(kcg2 )= + Gain(kcg2 )+(0.0076*(1-B) + 0.0057*B )*r(189)
     &                +(0.0076*(1-B) + 0.0057*B )*r(190)
        Gain(kcg3 )= + Gain(kcg3 )+(0.0038*(1-B) + 0.0038*B )*r(189)
     &                +(0.0038*(1-B) + 0.0038*B )*r(190)
        Gain(kcg4 )= + Gain(kcg4 )+(0.0000 )*r(189)
     &                +(0.0000 )*r(190)

C	TERP -> BSOG
        Gain(kcg1 )= +Gain(kcg1 )+(0.0541*(1-B) + 0.0061*B )*r(193)
     &                +(0.0541*(1-B) + 0.0061*B )*r(194)
     &                +(0.0541*(1-B) + 0.0061*B )*r(195)
     &                +(0.0541*(1-B) + 0.0061*B )*r(196)
        Gain(kcg2 )= +Gain(kcg2 )+(0.0463*(1-B) + 0.0613*B )*r(193)
     &                +(0.0463*(1-B) + 0.0613*B )*r(194)
     &                +(0.0463*(1-B) + 0.0613*B )*r(195)
     &                +(0.0463*(1-B) + 0.0613*B )*r(196)
        Gain(kcg3 )= +Gain(kcg3 )+(0.1809*(1-B) + 0.1014*B )*r(193)
     &                +(0.1809*(1-B) + 0.1014*B )*r(194)
     &                +(0.1809*(1-B) + 0.1014*B )*r(195)
     &                +(0.1809*(1-B) + 0.1014*B )*r(196)
        Gain(kcg4 )= +Gain(kcg4 )+(0.3065*(1-B) + 0.2558*B )*r(193)
     &                +(0.3065*(1-B) + 0.2558*B )*r(194)
     &                +(0.3065*(1-B) + 0.2558*B )*r(195)
     &                +(0.3065*(1-B) + 0.2558*B )*r(196)

C	SESQ -> BSOG  (Based on oxidation of monoterpenes)
        Gain(kcg1 )= +Gain(kcg1 )+(0.0170 )*r(193)+(0.0170 )*r(194)
     &                +(0.0170 )*r(195)+(0.0170 )*r(196)
        Gain(kcg2 )= +Gain(kcg2 )+(0.0340 )*r(193)+(0.0340 )*r(194)
     &                +(0.0340 )*r(195)+(0.0340 )*r(196)
        Gain(kcg3 )= +Gain(kcg3 )+(0.1700 )*r(193)+(0.1700 )*r(194)
     &                +(0.1700 )*r(195)+(0.1700 )*r(196)
        Gain(kcg4 )= +Gain(kcg4 )+(0.2040 )*r(193)+(0.2040 )*r(194)
...
C
         ro = 1.5
         Gain(kcg1) = Gain(kcg1)*ro
         Gain(kcg2) = Gain(kcg2)*ro
         Gain(kcg3) = Gain(kcg3)*ro
         Gain(kcg4) = Gain(kcg4)*ro

c-------SAPRC SOA aging reactions
c
        Loss(kcg5 )= +( 0.000)*r(216)    ! EXLVOCS
        Loss(kcg1 )= +( 1.000)*r(212)
        Loss(kcg2 )= +( 1.000)*r(213)
        Loss(kcg3 )= +( 1.000)*r(214)
        Loss(kcg4 )= +( 1.000)*r(215)
        
c Oxidation causes one-bin volatility shift

        Gain(kcg1 )= + Gain(kcg1) +( 1.075)*r(213)+( 0.0  )*r(214)
     &               + ( 0.0  )*r(215)

        Gain(kcg2 )= + Gain(kcg2) +( 0.0  )*r(213)+( 1.075)*r(214)
     &               +( 0.0  )*r(215)
     
        Gain(kcg3 )= + Gain(kcg3) +( 0.0  )*r(213)+( 0.0  )*r(214)
     &               +( 1.075)*r(215)

        Gain(kcg4 )= + Gain(kcg4) +( 0.0  )*r(213)+( 0.0  )*r(214)
     &               +( 0.0  )*r(215)

        Gain(kcg5 )= + Gain(kcg5) +( 0.0  )*r(213)+( 0.0  )*r(214)
     &               +( 0.0  )*r(215)+ ( 1.075  )*r(212)
