      subroutine ieslow4(r,rate,gain,loss,nr,ny,n1,n2)
c
c-----CAMx v4.02 030709
c
c     IESLOW4 computes reaction rates for slow state species
c
...
c  ETOH  ISPD  OLE2   CG1   CG2   CG3   CG4
c
     ...
     &                +( 0.200)*r( 78)+( 0.200)*r( 96)
        Loss(iOLE2 )= +( 1.000)*r( 97)+( 1.000)*r( 98)+( 1.000)*r( 99)
     &                +( 1.000)*r(100)


        Gain(iCG1  )= +( 0.070)*r( 63)+( 0.044)*r( 72)

        Gain(iCG2  )= +( 0.137)*r( 63)+( 0.192)*r( 72)

        Gain(iCG3  )= +( .0024)*r( 52)+( .0024)*r( 56)+( .0024)*r( 57)
     &                +( .0024)*r( 58)+( .0024)*r( 59)+( 0.036)*r( 66)
     &                +( 0.036)*r( 67)

        Gain(iCG4  )= +( 0.136)*r( 97)+( 0.136)*r( 98)+( 0.136)*r( 99)
     &                +( 0.136)*r(100)
c
      do l=n1,n2
