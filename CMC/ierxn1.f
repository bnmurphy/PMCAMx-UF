      subroutine ierxn1(y,ny,r,rk,nk)
c
c-----CAMx v4.02 030709
c
...
c
      ...
      r( 97) = rk( 97)*y(iCL2)
      r( 98) = rk( 98)*y(iHOCL)
      r( 99) = rk( 99)*y(iCL)*y(iO3)
      r(100) = rk(100)*y(iCLO)*y(iNO)
      r(101) = rk(101)*y(iCLO)*y(iHO2)
      r(102) = rk(102)*y(iCL)*y(iPAR)
      r(103) = rk(103)*y(iCL)*y(iOLE)
      r(104) = rk(104)*y(iCL)
      r(105) = rk(105)*y(iCL)*y(iETH)
      r(106) = rk(106)*y(iCL)*y(iISOP)
      r(107) = rk(107)*y(iOH)*y(iICL1)
      r(108) = rk(108)*y(iCL)*y(iBUTA)
      r(109) = rk(109)*y(iOH)*y(iBCL1)
      r(110) = rk(110)*y(iCLO)*y(iCLO)
c
      return
      end
