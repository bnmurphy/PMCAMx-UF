      subroutine radslvr2(ldark,H2O,M,O2,CH4,H2,cncrad,conc,r)
c
c-----CAMx v4.02 030709
c
c     RADSLVR2 initializes radical concentrations
c
...
c
  ...
  13  kount = kount + 1
      if (kount.gt.100) then
        write(iout,'(//,A)') 'ERROR in RADSLVR2:'
        write(iout,*) 'No Convergence in RADSLVR2, errbig = ', errbig
...
c
     ...
     &                +( 1.000)*r( 74)+( 0.600)*r( 75)+( 0.670)*r( 76)
     &                +( 0.440)*r( 77)+( 1.000)*r( 82)+( 1.000)*r( 84)
     &                +( 1.000)*r( 85)
     ...
     &                      +( 1.000)*r( 86)+( 1.000)*r( 89)
          ...
          JAC(kXO2N,kOH  )= +(-0.130)*r( 52)+(-0.130)*r( 76)
