      subroutine ierate1(neq,t,y,rate,rk,r,gain,loss)
c
c-----CAMx v4.02 030709
c
c     IERATE1 computes rates for LSODE in the IEH solver
c
...
c    CL
c
        Loss(iCL   )= +( 1.000)*r( 99)+( 1.000)*r(102)+( 1.000)*r(103)
     &                +( 1.000)*r(104)+( 1.000)*r(105)+( 1.000)*r(106)
     &                +( 1.000)*r(108)
        Gain(iCL   )= +( 2.000)*r( 97)+( 1.000)*r( 98)+( 1.000)*r(100)
     &                +( 1.400)*r(110)
...
c   CLO
c
        Loss(iCLO  )= +( 1.000)*r(100)+( 1.000)*r(101)+( 2.000)*r(110)
        Gain(iCLO  )= +( 1.000)*r( 99)
...
c
     ...
     &                +( 0.090)*r( 59)+( 0.088)*r( 76)+( 0.130)*r(102)
        ...
        Gain(iROR  )= +( 0.760)*r( 52)+( 0.760)*r(102)
