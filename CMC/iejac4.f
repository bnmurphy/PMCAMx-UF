      subroutine iejac4(neq,t,y,ml,mu,jac,njac,rk,r,loss,gain)
c
c-----CAMx v4.02 030709
c
c     IEJAC4 computes the Jacobian for LSODE in the IEH solver
c
...
c
     ...
     &                      +(-0.075)*r( 94)+(-0.910)*r(100)
          JAC(iXO2N,iNO3 )= +(-0.090)*r( 59)+(-0.090)*r(100)
