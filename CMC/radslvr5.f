...
c        do l=1,ngas
c          write(iout,'(i3,2x,a7,1pe10.3)') l,spname(l),conc(l)
c        enddo
c        write(iout,*) 'The radicals are: '
c        do l= 1 , nrad
c          write(iout,'(i3,2x,a7,1pe10.3)')
c     &          l,nmrad(l),cncrad(l)
c        enddo
        write(iout,*) 'Currently solving ', nstrt, ' to ',nendcp
c        do l=nstrt,nendcp
c          write(iout,'(i3,2x,a7,1p2e10.3)')
c     &          l,nmrad(l),cncrad(l),abs(rate(l))/cncrad(l)
c        enddo
        call camxerr()
      endif
      do i=nstrt,nend
...
cdavid     &                +( 1.000)*r(217)+( 1.000)*r(218)+( 1.000)*r(219)
cdavid     &                +( 1.000)*r(220)+( 1.000)*r(221)+( 1.000)*r(222)
cdavid     &                +( 1.000)*r(223)+( 1.000)*r(224)+( 1.000)*r(225)
cdavid     &                +( 1.000)*r(226)+( 1.000)*r(227)+( 1.000)*r(228)
cdavid     &                +( 1.000)*r(229)+( 1.000)*r(230)+( 1.000)*r(231)
cdavid     &                +( 1.000)*r(232)+( 1.000)*r(233)+( 1.000)*r(234)
cdavid     &                +( 1.000)*r(235)+( 1.000)*r(236)+( 1.000)*r(237)
...
cdavid     &                      +( 1.000)*r(217)+( 1.000)*r(218)
cdavid     &                      +( 1.000)*r(219)+( 1.000)*r(220)
cdavid     &                      +( 1.000)*r(221)+( 1.000)*r(222)
cdavid     &                      +( 1.000)*r(223)+( 1.000)*r(224)
cdavid     &                      +( 1.000)*r(225)+( 1.000)*r(226)
cdavid     &                      +( 1.000)*r(227)+( 1.000)*r(228)
cdavid     &                      +( 1.000)*r(229)+( 1.000)*r(230)
cdavid     &                      +( 1.000)*r(231)+( 1.000)*r(232)
cdavid     &                      +( 1.000)*r(233)+( 1.000)*r(234)
cdavid     &                      +( 1.000)*r(235)+( 1.000)*r(236)
cdavid     &                      +( 1.000)*r(237)
          JAC(kOH  ,kOH  )=JAC(kOH  ,kOH  )
...
cdavid      r(216) = rk(216)*cncrad(kOH)*conc(kCPO5)
cdavid      r(217) = rk(217)*cncrad(kOH)*conc(kCPO6)
cdavid      r(218) = rk(218)*cncrad(kOH)*conc(kCPO7)
cdavid      r(219) = rk(219)*cncrad(kOH)*conc(kCPO8)
cdavid      r(220) = rk(220)*cncrad(kOH)*conc(kCPO9)
cdavid      r(221) = rk(221)*cncrad(kOH)*conc(kCOO1)
cdavid      r(222) = rk(222)*cncrad(kOH)*conc(kCOO2)
cdavid      r(223) = rk(223)*cncrad(kOH)*conc(kCOO3)
cdavid      r(224) = rk(224)*cncrad(kOH)*conc(kCOO4)
cdavid      r(225) = rk(225)*cncrad(kOH)*conc(kCOO5)
cdavid      r(226) = rk(226)*cncrad(kOH)*conc(kCOO6)
cdavid      r(227) = rk(227)*cncrad(kOH)*conc(kCOO7)
cdavid      r(228) = rk(228)*cncrad(kOH)*conc(kCOO8)
cdavid      r(229) = rk(229)*cncrad(kOH)*conc(kCOO9)
cdavid      r(230) = rk(230)*cncrad(kOH)*conc(kCBS1)
cdavid      r(231) = rk(231)*cncrad(kOH)*conc(kCBS2)
cdavid      r(232) = rk(232)*cncrad(kOH)*conc(kCBS3)
cdavid      r(233) = rk(233)*cncrad(kOH)*conc(kCBS4)
cdavid      r(234) = rk(234)*cncrad(kOH)*conc(kCAS1)
cdavid      r(235) = rk(235)*cncrad(kOH)*conc(kCAS2)
cdavid      r(236) = rk(236)*cncrad(kOH)*conc(kCAS3)
cdavid      r(237) = rk(237)*cncrad(kOH)*conc(kCAS4)
                                                   
c      if (errbig.gt.tol) goto 14
      if (errbig.gt.tol) then
        if (kount.lt.499) goto 14
        if (errbig.gt.tol2) goto 14
      endif
c
c  new group of radicals
c
