...
c
     ...
     &                      +(-0.100)*r( 58)
          ...
          JAC(lOH  ,lOLE2)= +(-0.200)*r( 97)+( 1.000)*r( 98)
     &                      +(-0.100)*r( 99)
     ...
     &                      +(-0.925)*r( 94)+(-1.033)*r( 95)
          ...
          JAC(lHO2 ,lOLE2)= +(-0.380)*r( 97)+(-1.000)*r( 98)
     &                      +(-0.440)*r( 99)
     ...
     &                      +(-0.643)*r( 94)+(-0.333)*r( 95)
          JAC(lCO  ,lOLE2)= +(-0.300)*r( 97)+(-0.330)*r( 99)
     ...
     &                      +(-0.150)*r( 93)+(-0.740)*r( 99)
          JAC(lFORM,lNO3 )= +( 1.000)*r( 41)+(-1.000)*r( 59)
     &                      +(-0.282)*r( 94)+(-1.000)*r(100)
     ...
     &                      +(-0.282)*r( 94)+(-0.900)*r( 95)
          ...
          JAC(lFORM,lOLE2)= +(-0.200)*r( 97)+(-1.000)*r( 98)
     ...
     &                      +(-0.357)*r( 94)+(-0.067)*r( 95)
          ...
          JAC(lALD2,lOLE2)= +(-0.630)*r( 97)+(-1.000)*r( 98)
     ...
     &                      +(-0.075)*r( 94)+(-0.700)*r( 95)
          JAC(lXO2 ,lOLE2)= +(-0.280)*r( 97)+(-1.000)*r( 98)
     ...
     &                      +(-1.282)*r( 94)+(-0.832)*r( 95)
          JAC(lPAR ,lOLE2)= +(-0.220)*r( 97)+( 1.000)*r( 98)
     &                      +( 1.000)*r( 99)+( 1.000)*r(100)
          JAC(lXO2N,lNO  )= +( 1.000)*r( 81)
          JAC(lXO2N,lO   )= +(-0.020)*r( 56)+(-0.020)*r( 97)
          JAC(lXO2N,lNO3 )= +(-0.090)*r( 59)+(-0.090)*r(100)
     ...
     &                      +( 4.000)*r( 88)+( 1.000)*r( 89)
          ...
          JAC(lXO2N,lOLE2)= +(-0.020)*r( 97)+(-0.090)*r(100)
          JAC(lROR ,lNO2 )= +( 1.000)*r( 55)
          JAC(lROR ,lOH  )= +(-0.760)*r( 52)
          JAC(lROR ,lPAR )= +(-0.760)*r( 52)
          JAC(lROR ,lROR )= +( 1.000)*r( 53)+( 1.000)*r( 54)
     &                      +( 1.000)*r( 55)
          JAC(lCG3 ,lO   )= +(-.0024)*r( 56)
          JAC(lCG3 ,lO3  )= +(-.0024)*r( 58)
          JAC(lCG3 ,lNO3 )= +(-.0024)*r( 59)+(-0.036)*r( 67)
          JAC(lCG3 ,lOH  )= +(-.0024)*r( 52)+(-.0024)*r( 57)
     &                      +(-0.036)*r( 66)
          JAC(lCG3 ,lPAR )= +(-.0024)*r( 52)
          JAC(lCG3 ,lOLE )= +(-.0024)*r( 56)+(-.0024)*r( 57)
     &                      +(-.0024)*r( 58)+(-.0024)*r( 59)
          JAC(lCG3 ,lCRES)= +(-0.036)*r( 66)+(-0.036)*r( 67)
     ...
     &                      +(-0.200)*r( 72)
          ...
          JAC(lCG1 ,lOH  )= +(-0.070)*r( 63)+(-0.044)*r( 72)
          JAC(lCG1 ,lTOL )= +(-0.070)*r( 63)
          JAC(lCG1 ,lXYL )= +(-0.044)*r( 72)
          JAC(lCG2 ,lOH  )= +(-0.137)*r( 63)+(-0.192)*r( 72)
          JAC(lCG2 ,lTOL )= +(-0.137)*r( 63)
          JAC(lCG2 ,lXYL )= +(-0.192)*r( 72)
     ...
     &                      +( 1.000)*r( 94)+( 1.000)*r( 95)
          ...
          JAC(lOLE2,lO   )= +( 1.000)*r( 97)
          JAC(lOLE2,lO3  )= +( 1.000)*r( 99)
          JAC(lOLE2,lNO3 )= +( 1.000)*r(100)
          JAC(lOLE2,lOH  )= +( 1.000)*r( 98)
          JAC(lOLE2,lOLE2)= +( 1.000)*r( 97)+( 1.000)*r( 98)
     &                      +( 1.000)*r( 99)+( 1.000)*r(100)
          JAC(lCG4 ,lO   )= +(-0.136)*r( 97)
          JAC(lCG4 ,lO3  )= +(-0.136)*r( 99)
          JAC(lCG4 ,lNO3 )= +(-0.136)*r(100)
          JAC(lCG4 ,lOH  )= +(-0.136)*r( 98)
          JAC(lCG4 ,lOLE2)= +(-0.136)*r( 97)+(-0.136)*r( 98)
     &                      +(-0.136)*r( 99)+(-0.136)*r(100)
c
      do j=1,njac
        if(y(j).le.0.0) then
