      subroutine ddmjac1(njac,nrxn,y,jac,r)
c
c-----CAMx v4.02 030709
c
c     DDMJAC1 computes a full Jacobian
c
...
c
     ...
     &                      +(-0.100)*r( 58)
          ...
          JAC(lOH  ,lHOCL)= +(-1.000)*r( 98)
          JAC(lOH  ,lICL1)= +( 1.000)*r(107)
          JAC(lOH  ,lBCL1)= +( 1.000)*r(109)
     ...
     &                      +(-0.440)*r( 58)+(-1.000)*r(103)
          JAC(lHO2 ,lETH )= +(-1.700)*r( 60)+(-1.000)*r( 61)
     &                      +(-0.120)*r( 62)+(-1.000)*r(105)
     ...
     &                      +(-0.925)*r( 94)+(-1.033)*r( 95)
          ...
          JAC(lHO2 ,lCL  )= +(-1.000)*r(103)+(-1.000)*r(104)
     &                      +(-1.000)*r(105)+(-1.000)*r(106)
     &                      +(-1.000)*r(108)
          JAC(lHO2 ,lCLO )= +( 1.000)*r(101)
          JAC(lHO2 ,lBUTA)= +(-1.000)*r(108)
     ...
     &                      +(-0.282)*r( 94)+(-0.900)*r( 95)
          ...
          JAC(lFORM,lCL  )= +(-1.000)*r(104)+(-1.000)*r(105)
     ...
     &                      +( 1.000)*r( 86)+( 1.000)*r( 89)
          JAC(lXO2 ,lPAR )= +(-0.870)*r( 52)+(-0.870)*r(102)
     ...
     &                      +(-1.000)*r( 96)+(-1.000)*r(106)
          JAC(lXO2 ,lISPD)= +(-0.713)*r( 92)+(-0.064)*r( 93)
     &                      +(-0.075)*r( 94)+(-0.700)*r( 95)
          JAC(lXO2 ,lCL  )= +(-0.870)*r(102)+(-2.000)*r(103)
     &                      +(-1.000)*r(104)+(-2.000)*r(105)
     &                      +(-1.000)*r(106)+(-1.000)*r(108)
          JAC(lXO2 ,lBUTA)= +(-1.000)*r(108)
     ...
     &                      +(-1.282)*r( 94)+(-0.832)*r( 95)
          JAC(lPAR ,lCL  )= +( 1.000)*r(102)+( 0.110)*r(102)
     &                      +( 1.000)*r(103)
          ...
          JAC(lXO2N,lPAR )= +(-0.130)*r( 52)+(-0.130)*r(102)
     ...
     &                      +( 4.000)*r( 88)+( 1.000)*r( 89)
          ...
          JAC(lXO2N,lCL  )= +(-0.130)*r(102)
          JAC(lROR ,lNO2 )= +( 1.000)*r( 55)
          JAC(lROR ,lOH  )= +(-0.760)*r( 52)
          JAC(lROR ,lPAR )= +(-0.760)*r( 52)+(-0.760)*r(102)
          JAC(lROR ,lROR )= +( 1.000)*r( 53)+( 1.000)*r( 54)
     &                      +( 1.000)*r( 55)
          JAC(lROR ,lCL  )= +(-0.760)*r(102)
     ...
     &                      +( 1.000)*r( 94)+( 1.000)*r( 95)
          ...
          JAC(lCL2 ,lCL2 )= +( 1.000)*r( 97)
          JAC(lCL2 ,lCLO )= +(-0.600)*r(110)
          JAC(lCL  ,lNO  )= +(-1.000)*r(100)
          JAC(lCL  ,lO3  )= +( 1.000)*r( 99)
          JAC(lCL  ,lPAR )= +( 1.000)*r(102)
          JAC(lCL  ,lOLE )= +( 1.000)*r(103)
          JAC(lCL  ,lETH )= +( 1.000)*r(105)
          JAC(lCL  ,lISOP)= +( 1.000)*r(106)
          JAC(lCL  ,lCL2 )= +(-2.000)*r( 97)
          JAC(lCL  ,lCL  )= +( 1.000)*r( 99)+( 1.000)*r(102)
     &                      +( 1.000)*r(103)+( 1.000)*r(104)
     &                      +( 1.000)*r(105)+( 1.000)*r(106)
     &                      +( 1.000)*r(108)
          JAC(lCL  ,lHOCL)= +(-1.000)*r( 98)
          JAC(lCL  ,lCLO )= +(-1.000)*r(100)+(-2.800)*r(110)
          JAC(lCL  ,lBUTA)= +( 1.000)*r(108)
          JAC(lHOCL,lHO2 )= +(-1.000)*r(101)
          JAC(lHOCL,lHOCL)= +( 1.000)*r( 98)
          JAC(lHOCL,lCLO )= +(-1.000)*r(101)
          JAC(lCLO ,lNO  )= +( 1.000)*r(100)
          JAC(lCLO ,lO3  )= +(-1.000)*r( 99)
          JAC(lCLO ,lHO2 )= +( 1.000)*r(101)
          JAC(lCLO ,lCL  )= +(-1.000)*r( 99)
          JAC(lCLO ,lCLO )= +( 1.000)*r(100)+( 1.000)*r(101)
     &                      +( 4.000)*r(110)
          JAC(lHCL ,lPAR )= +(-1.000)*r(102)
          JAC(lHCL ,lISOP)= +(-0.150)*r(106)
          JAC(lHCL ,lCL  )= +(-1.000)*r(102)+(-1.000)*r(104)
     &                      +(-0.150)*r(106)
          JAC(lRCHO,lPAR )= +(-0.110)*r(102)
          JAC(lRCHO,lOLE )= +(-1.000)*r(103)
          JAC(lRCHO,lCL  )= +(-0.110)*r(102)+(-1.000)*r(103)
          JAC(lFMCL,lOLE )= +(-1.000)*r(103)
          JAC(lFMCL,lETH )= +(-1.000)*r(105)
          JAC(lFMCL,lCL  )= +(-1.000)*r(103)+(-1.000)*r(105)
          JAC(lICL1,lOH  )= +( 1.000)*r(107)
          JAC(lICL1,lISOP)= +(-0.280)*r(106)
          JAC(lICL1,lCL  )= +(-0.280)*r(106)
          JAC(lICL1,lICL1)= +( 1.000)*r(107)
          JAC(lICL2,lOH  )= +(-1.000)*r(107)
          JAC(lICL2,lICL1)= +(-1.000)*r(107)
          JAC(lBUTA,lCL  )= +( 1.000)*r(108)
          JAC(lBUTA,lBUTA)= +( 1.000)*r(108)
          JAC(lBCL1,lOH  )= +( 1.000)*r(109)
          JAC(lBCL1,lCL  )= +(-0.700)*r(108)
          JAC(lBCL1,lBUTA)= +(-0.700)*r(108)
          JAC(lBCL1,lBCL1)= +( 1.000)*r(109)
          JAC(lBCL2,lOH  )= +(-1.000)*r(109)
          JAC(lBCL2,lBCL1)= +(-1.000)*r(109)
c
      do j=1,njac
        if(y(j).le.0.0) then
          write(iout,'(//,A)') 'ERROR in DDMJAC1:'
          write(iout,*)
          write(iout,*) ' Zero concentration in DDMJAC1 for spec', j
          do i=1,njac
