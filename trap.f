...
c
      ...
      real h2so4_i !initial h2so4 [=]ppm
...
c
      call radslvr(ldark,H2O,atm,O2,CH4,H2,cncrad,ctmp,rrxn,crold,dt)
c
...
c======================== DDM End   =======================
c
c-----Extract sulfuric acid production rate from difference
c     between the updated concentration and the saved conc.
c
      dsulfdt=(conc(ksulf)-h2so4_i)/dtin*1.0d6
          !sulfuric production rate as ppt/hr, by jgj 12/13/07
c------------------------------------------------------------------
      !Debug for dsulfdt
